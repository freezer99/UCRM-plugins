...
## Usage
* In UCRM admin, go to System / Plugins / SMS notifications via Twilio
* Click Test Webhook
* In the log output, you should see `Webhook test successful.`
* To temporarily disable sending and/or to change the list of events, click Edit webhook. 
